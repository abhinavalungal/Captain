...
--  Run db/001_schema.sql first (node db/setup.js --no-seed).
-- ============================================================================

TRUNCATE kris.geoform_reports, kris.veson_legs, kris.veson_offhire, kris.vessels RESTART IDENTITY CASCADE;

INSERT INTO kris.vessels (id, imo, name, department) VALUES
...
INSERT INTO kris.veson_offhire (imo, vessel_name, start_time, end_time, start_date, offhire_hours, offhire_days, reason) VALUES
