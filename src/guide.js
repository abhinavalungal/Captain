...
const GUIDE = [
  ...
  {
    id: 'what-is-captain',
    title: 'What Captain can do',
    answer: 'I can answer questions about your vessel data straight from the records, help you find things in the app, and give you a quick briefing on request. I never make up a figure \u2014 if the data does not have it, I say so.',
    aliases: ['what can you do', 'what are you', 'who are you', 'help', 'what is captain', 'introduce yourself'],
  },
];
